...
public:
	...
	virtual void getTexCoord(glm::vec3 p, float& texcoords, float& texcoordt) = 0;
	virtual ~SceneObject() {}
	...
	void setTexture(bool flag, int textureID); // textures
	glm::vec3 getColor();
